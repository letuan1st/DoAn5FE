        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoTap = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaTapPhim = table.Column<string>(nullable: false),
                    TapSo = table.Column<string>(nullable: false),
                    Link = table.Column<string>(nullable: false),
                    NgayDang = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TapPhims", x => x.MaTapPhim);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TLofPhims", x => x.MaPhim);
                });
